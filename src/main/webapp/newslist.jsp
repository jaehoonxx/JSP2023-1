...
<title>뉴스 관리 앱</title>
   ...
   <div class="container w-75 mt-5 mx-auto">
	...
	<c:forEach var ="news" items="${newslist}">	
		<li><a href="ncontrol?action=getNews&aid=${news.aid}">${news.title }, ${news.date}
		</li>
		</c:forEach>
	</ul>
	<hr>
	...
	<div class="collapse" id="addForm">
	  <div class="card card-body">
		<form method="post" action="/01firstpjt/ncontrol?action=addNews" enctype="multipart/form-data">
